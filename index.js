...
MyContext.displayName = "Chung cư ABC";
...
// Action
const createAccount = (email, password, fullName, phone, address,idroom, role) => {
    auth().createUserWithEmailAndPassword(email, password, fullName, phone, address,idroom, role)
    .then(() => {
